...
int main(void) {
    ...
    while (1) {
        ...
        if (tamanhoPalavra < 2) {
            printf("A palavra deve ter pelo menos 2 caracteres.\n");
        } else {
            contador = 0;
